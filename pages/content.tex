...
\chapter{The shortcode options}

\section{Available options for the shortcode}
...
\section{\texttt{\{role\}} Text for a certain role}
...
\section{\texttt{\{recipient\}} Text for a specific or multiple users}
...
\section{\texttt{\{custom\_role\}} Text for custom or multiple roles}
...
not by Editors (even if Editors is a higher role that Author).

\section{\texttt{\{reverse\}} Reverse the logic of hiding text}
...
\subsection{Use of the \texttt{reverse} option for single users}
...
\subsection{Use of the \texttt{reverse} option for roles}
...
\section{\texttt{\{align\}} Align style}
...
\section{\texttt{\{alt\}} Alternate text for excluded users}
...
\section{\texttt{\{container\}} The \textsc{html} container for the text}
...
\section{\texttt{\{id\}} Custom \textsc{id}s for the \textsc{html} container}
...
The single \textsc{id} names must be separated by a comma, not by a space. Also,
...
\section{\texttt{\{class\}} Custom classes for the \textsc{html} container}
